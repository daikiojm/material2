...
import {DialogPositionFull} from './dialog-config';
 ...
 */
export class MdDialogRefFull<T> {
  ...
  constructor(
    ...
    private _containerInstance: MdDialogContainerFull,
   ...
   */
  updatePosition(position?: DialogPositionFull): this {
