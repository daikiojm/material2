...
export class MdDialogCloseFull implements OnChanges {
  ...
  constructor(public dialogRef: MdDialogRefFull<any>) { }
...
export class MdDialogTitleFull implements OnInit {
  @Input() id = `md-dialog-title-${dialogElementUid++}`;

  constructor(@Optional() private _container: MdDialogContainerFull) { }
...
export class MdDialogContentFull { }
...
export class MdDialogActionsFull { }
